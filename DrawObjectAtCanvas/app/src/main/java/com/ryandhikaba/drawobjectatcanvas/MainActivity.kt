package com.ryandhikaba.drawobjectatcanvas

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.ryandhikaba.drawobjectatcanvas.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        canvas.drawColor(ResourcesCompat.getColor(resources, R.color.colorGreen, null))
        ...
        paint.color = ResourcesCompat.getColor(resources, R.color.colorRed, null)
